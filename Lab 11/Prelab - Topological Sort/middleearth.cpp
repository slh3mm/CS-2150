...
/** @details This is not my original code, I merely edited and commented it
 *  @date 4/24/2022
 *  @emoji smile
 */
...
/**
 * @brief Shuffles a vector that uses the Mersenne Twister engine
 *
 * @return void
 * @param first specifies the starting point of where to shuffle
 * @param last specifies the ending point of where to shuffle
 * @param g a random number generator to shuffle according to
 */
...
/**
 * @brief Lis of cities that will be used to represent TSP problem
 */
